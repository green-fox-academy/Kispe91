...
{
    int numberOfLines = 3;
    std::vector <int> xCoordinates = {0, 100, 200};
    std::vector <int> yCoordinates = {0, 200, 400};

    for (int j = 0; j < numberOfLines; ++j) {
        SDL_SetRenderDrawColor(gRenderer, 0x00, 0x00, 0x00, 0xFF);
        SDL_RenderDrawLine(gRenderer, xCoordinates[j], yCoordinates[j], SCREEN_WIDTH/2, SCREEN_HEIGHT/2);
    }

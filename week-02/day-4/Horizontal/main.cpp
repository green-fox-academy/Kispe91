...
{
    int numberOfLines = 3;
    std::vector <int> xCoordinates = {0, 200, 400};
    std::vector <int> yCoordinates = {50, 150, 250};
    int lengthOfLine = 50;
    for (int i = 0; i < numberOfLines; ++i) {
        SDL_SetRenderDrawColor(gRenderer, 0x00, 0x00, 0x00, 0xFF);
        SDL_RenderDrawLine(gRenderer, xCoordinates[i], yCoordinates[i], xCoordinates[i] + lengthOfLine, yCoordinates[i] );
    }
